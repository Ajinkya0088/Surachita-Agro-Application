...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcProvidersUserDataTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      _createClass(UserData, [{
        ...
        value: function logout() {
          ...
          return this.storage.remove(this.HAS_LOGGED_IN).then(function () {
            _this2.storage.remove('id');

            _this2.storage.remove('name');

            _this2.storage.remove('username');
        ...
        key: "setDeatils",
        value: function setDeatils(response) {
